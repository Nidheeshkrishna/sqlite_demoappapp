    ...
    public ArrayList<datamodel> getAllCotacts() {
       ...
       // hp = new HashMap();
        ...
        while(res.isAfterLast() == false){
           ...
           // hp.put("name",res.getColumnIndex(CONTACTS_COLUMN_NAME));
            //array_list.add(res.getString(res.getColumnIndex(CONTACTS_COLUMN_NAME)));
            //array_list.add(res.getString(res.getColumnIndex(CONTACTS_COLUMN_PHONE)));
            obj.setName(res.getString(res.getColumnIndex(CONTACTS_COLUMN_NAME)));
            obj.setPhno(res.getString(res.getColumnIndex(CONTACTS_COLUMN_PHONE)));
           list.add(obj);
            res.moveToNext();
        }
        return list;
